   ...
   penalties.forEach(penalty => {
      ...
      if (penalty.positions > 0) {
         ...
         if (driverPenalised.finished == 0) {
            ...
            thisClass[driverPos + countPositionsAffected].finish_position_after_penalties = driverPenalised.finish_position_after_penalties + penalty.positions;
            thisClass[driverPos + countPositionsAffected].finish_position_in_class_after_penalties = driverPenalised.finish_position_in_class_after_penalties + penalty.positions;
           /* if (penalty.penalty_id > 3999 && class_index == 0) {
                console.log(thisClass);
      ...
      if (round.subsession_ids.length > 0) {
         ...
         classChanges.forEach(classChange => {
            ...
            if (classChange.change_from_round == round.round_no) {
               ...
               logger.log(" - - - Class change for driver ", classChange.cust_id, " to class ", classChange.new_class_number);
